  ...
  return (
    !!accountAddress && (
      <>
        ...
        <Card className="surface-ember flex flex-col md:flex-row items-center gap-4 md:has-[[data-address-revealed=true]]:flex-col md:has-[[data-address-revealed=true]]:items-stretch p-4 font-bold text-foreground transition-colors hover:border-primary/40">
